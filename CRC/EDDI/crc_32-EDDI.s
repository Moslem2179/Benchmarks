...
# BB#0:                                 # %entry
	...
	l.slli	r16, r16, 2
	l.slli	r3, r3, 2
	l.movhi	r18, hi(crc_32_tab)
	l.movhi	r5, hi(crc_32_tab)
	l.ori	r18, r18, lo(crc_32_tab)
...
# BB#0:                                 # %entry
	...
	l.addi	r18, r0, -1
	l.addi	r5, r0, -1
	l.movhi	r20, hi(crc_32_tab)
	l.movhi	r7, hi(crc_32_tab)
	l.ori	r20, r20, lo(crc_32_tab)
	l.ori	r7, r7, lo(crc_32_tab)
.LBB1_1:                                # %while.body
                                        # =>This Inner Loop Header: Depth=1
	l.xor	r21, r18, r19           # CFC
	l.xor	r8, r5, r6
	l.andi	r21, r21, 255
	l.andi	r8, r8, 255
	l.slli	r21, r21, 2
...
# BB#1:                                 # %for.body.preheader
	l.addi	r18, r0, -1
	l.addi	r5, r0, -1
	l.movhi	r19, hi(crc_32_tab)
	l.movhi	r6, hi(crc_32_tab)
	l.ori	r19, r19, lo(crc_32_tab)
...
.L.str:
	...
	.type	s_crc_32_tab,@object      # @crc_32_tab
	#.section	.rodata,"a",@progbits
	.p2align	13
s_crc_32_tab:
	.long	0                       # 0x0
