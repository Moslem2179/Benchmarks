...
s_qHead:
	.long	0
	.size	s_qHead, 4
	.hidden	s_AdjMatrix               # @s_AdjMatrix
	.type	s_AdjMatrix,@object
	.globl	s_AdjMatrix
	.p2align	2
s_AdjMatrix:
	.long	32                      # 0x20
	...
	.long	10                      # 0xa
	.long	16                      # 0x10
	.size	s_AdjMatrix, 144
	.hidden	s_g_qCount                # @s_g_qCount
	.type	s_g_qCount,@object
	#.section	.bss,"aw",@nobits
	.globl	s_g_qCount
	.p2align	2
s_g_qCount:
...
s_ch: 
	.long	0
	.hidden	s_rgnNodes                # @rgnNodes
	.type	s_rgnNodes,@object
s_rgnNodes:
	.long	0
	.long	0
	.long	0
	...
	.long	0
	.long	0
	.hidden	s_iNode                   # @iNode
	.type	s_iNode,@object
s_iNode:
	.long	0
	.hidden	s_iDist                   # @iDist
	.type	s_iDist,@object
s_iDist:
	.long	0
	.hidden	s_iPrev                   # @iPrev
	.type	s_iPrev,@object
s_iPrev:
	.long	0
	.hidden	s_i                       # @i
